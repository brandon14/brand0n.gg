...
module.exports = {
  theme: {
    ...
    colors: {
      ...
      white:  colors.trueGray['50'],
      // Add in our custom color palette.
      ...customColors,
      ...
      neutral: {
        ...
        dark: colors.trueGray['50'],
        ...colors.trueGray,
      },
      // Primary: primary brand color with a default fallback if you don't need shades. Always set a DEFAULT when you use shades.
      primary: {
        DEFAULT: customColors['strem-pink'],
        dark: customColors['strem-pink'],
        ...colors.pink,
      },
      secondary: {
        DEFAULT: customColors['strem-blue'],
        dark: customColors['strem-blue'],
        ...colors.blue,
      },
    },
    extend: {
